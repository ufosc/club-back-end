...
/// Checks the plaintext password against the hash tring to see if the password is valid.
/// 
/// This can take upwards of 4 seconds to verify with the scrypt params.... Not great. 
/// 
